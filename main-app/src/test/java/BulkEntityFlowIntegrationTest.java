...
public class BulkEntityFlowIntegrationTest {
    ...
    void bulkFlow_writesAllMetadata() {
        ...
        for (int i = 0; i < entityCount; i++) {
            ...
            restTemplate.postForEntity("/api/entity/hybrid/create", dto2, EntityDTO.class);
            ...
            for (int u = 1; u <= updates; u++) {
                ...
                restTemplate.put("/api/entity/hybrid/update/{id}", dto2, id2);
            }
            if (rand.nextBoolean()) {
                restTemplate.delete("/api/entity/kafka/delete/{id}", id);
                restTemplate.delete("/api/entity/delete/{id}", id1);
                restTemplate.delete("/api/entity/hybrid/delete/{id}", id2);
            }
        }
