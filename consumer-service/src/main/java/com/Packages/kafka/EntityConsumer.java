...
//    }
//
//    @KafkaListener(topics = "entity69", groupId = "es-consumer-group")
//    public void Consume(EntityEvent entityEvent) {
////        log.info("[EntityConsumer] got event id={} operation={}",
////                entityEvent.getId(),
...
//        try {
//            kafkaTemplate.send("dlq69", failedEvent.getEntity().getId(), failedEvent);
